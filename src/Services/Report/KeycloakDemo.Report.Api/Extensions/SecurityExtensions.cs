namespace KeycloakDemo.Report.Api.Extensions;
...
internal static class SecurityExtensions
{
    public static IServiceCollection AddKeycloakAuth(
        ...
        => services
            ...
            {
                options.AddPolicy("reportApiScope", policy =>
                {
                    policy.RequireAuthenticatedUser();
                    policy.RequireAssertion(ctx => ctx.User.HasClaim(c => c.Type is "scope" && c.Value.Contains("report")));
                });
            });
